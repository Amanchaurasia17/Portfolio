...
export const getAllSoftwareApplications = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://portfolio-a55l.onrender.com/api/v1/application/getall",
...
export const addNewSoftwareApplication = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://portfolio-a55l.onrender.com/api/v1/application/add",
      data,
      {
        withCredentials: true,
...
export const deleteSoftwareApplication = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://portfolio-a55l.onrender.com/api/v1/application/delete/${id}`,
      {
        withCredentials: true,
      }
    );
