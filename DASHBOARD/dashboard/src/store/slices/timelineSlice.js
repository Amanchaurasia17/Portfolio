...
export const getAllTimeline = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      "https://portfolio-a55l.onrender.com/api/v1/timeline/getall",
...
export const addNewTimeline = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      "https://portfolio-a55l.onrender.com/api/v1/timeline/add",
      data,
      {
        withCredentials: true,
...
export const deleteTimeline = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://portfolio-a55l.onrender.com/api/v1/timeline/delete/${id}`,
      {
        withCredentials: true,
      }
    );
